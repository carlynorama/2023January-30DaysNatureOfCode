...
function triangleContains_Full(pointToTest, a, b, c) {
...
function triangleContains_NecessaryStepsOnly(point, a, b, c) {
...
function triangleContains_MixingClockandCounterBrief(pointToTest, a, b, c) {
...
function triangleContains_MixingClockandCounterVerbose(point, a, b, c) {
    const AP = { x: point.x - a.x, y: point.y - a.y };
    const AB = { x: (b.x - a.x), y: (b.y - a.y) };
...
function triangleContains_UsingDeterminate(x, y, ax, ay, bx, by, cx, cy) {
