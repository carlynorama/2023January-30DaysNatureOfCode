...
function testSuite() {
    ...
    console.log("best members", DNA.toPhrase(bestMember_asWritten.bases), DNA.toPhrase(bestMember_recheck.bases), bestMember_asWritten.bases.every((v, i) => v === bestMember_recheck.bases[i]));
...
function drawFitnesses(maxPossible, fitnesses) {
