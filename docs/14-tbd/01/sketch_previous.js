...
//     mover1 = PolarMover.createPolarMover(prepAngle, noiseLoop1.scaledValue(prepAngle, 100 - spikeRange, 100 + spikeRange));
//     mover2 = PolarMover.createPolarMover(prepAngle, noiseLoop2.scaledValue(prepAngle, 100 - spikeRange, 100 + spikeRange));
//     mover3 = PolarMover.createPolarMover(prepAngle, noiseLoop3.scaledValue(prepAngle, 100 - spikeRange, 100 + spikeRange));
//     //------------------------------------------------------------------
//     background(204);
//     //noLoop();
// }
