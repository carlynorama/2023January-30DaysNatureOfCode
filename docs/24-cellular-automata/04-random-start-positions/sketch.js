...
//----------------------------------------------------------------
//------------------------------------------------ inject shapes
function insertGlider(rootIndex) {
...
function insertSpaceShip(rootIndex) {
...
function insertBeacon(rootIndex) {
