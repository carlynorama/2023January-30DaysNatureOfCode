...
function triangleContainsB(pointToTest: {x:number, y:number}, a:{x:number, y:number}, b:{x:number, y:number}, c: {x:number, y:number})
{
...
function triangleContainsA(x: number, y: number, ax: number, ay: number, bx: number, by: number, cx: number, cy: number) {
...
function triangleContainsC(pointToTest: Vector, a:Vector, b:Vector, c: Vector)
{
