...
//𝑃 is a point and 𝐴,𝐵 and 𝐶 are teh vertices of a triangle.
...
// 𝑃 is inside the triangle formed by 𝐴,𝐵 and 𝐶 if and only if all of the cross products, 𝐴𝐵×𝐴𝑃, 𝐵𝐶×𝐵𝑃 and 𝐶𝐴×𝐶𝑃, point in the same direction relative to the plane. 
...
// - https://www.google.com/books/edition/Graphics_Gems_IV/CCqzMm_-WucC?hl=en&gbpv=1&pg=PA24&printsec=frontcover
// - Future https://en.wikipedia.org/wiki/Shoelace_formula
